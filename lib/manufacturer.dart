...
class Manufacturer extends StatefulWidget {
  final int? manufacturer; // Paramètre optionnel pour la catégorie
  final String? manufacturername;

  Manufacturer({this.manufacturer,this.manufacturername}); // Constructeur avec paramètre
...
class _ManufacturerState extends State<Manufacturer> {
  ...
  Future<void> fetchProducts() async {
    try {
      ...
      final url = widget.manufacturer != null
          ? 'https://baskiti.ma/app/productsbymanufacturer.php?manufacturer=${widget.manufacturer}'
          : 'https://baskiti.ma/app/productsbymanufacturer.php';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "La marque ${widget.manufacturername}",
          style: TextStyle(
            fontSize: 15,
