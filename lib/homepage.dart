...
class HomePage extends StatelessWidget {
  ...
  final List<Brand> brands = [
    Brand(id: '1', name: 'Coca Cola', logoUrl: 'assets/brands/aicha.png'),
    Brand(id: '2', name: 'Nestlé', logoUrl: 'assets/brands/chakour.png'),
    Brand(id: '3', name: 'cristal', logoUrl: 'assets/brands/cristal.png'),
    Brand(id: '4', name: 'Unilever', logoUrl: 'assets/brands/dari.png'),
    Brand(id: '5', name: 'L\'Oréal', logoUrl: 'assets/brands/hala.png'),
    Brand(id: '6', name: 'Samsung', logoUrl: 'assets/brands/sultan.png'),
    Brand(id: '7', name: 'Apple', logoUrl: 'assets/brands/elnass.png'), 
       Brand(id: '1', name: 'Coca Cola', logoUrl: 'assets/brands/aicha.png'),
    Brand(id: '2', name: 'Nestlé', logoUrl: 'assets/brands/chakour.png'),
    Brand(id: '3', name: 'cristal', logoUrl: 'assets/brands/cristal.png'),
    Brand(id: '4', name: 'Unilever', logoUrl: 'assets/brands/dari.png'),
  ...
  final List<Category> categories = [
    Category(id: 1, name: 'Alimentaire', imageUrl: 'assets/categories/alimentaire.png'),
    Category(id: 1, name: 'Boissons', imageUrl: 'assets/categories/boissons.png'),
    Category(id: 1, name: 'Hygiène', imageUrl: 'assets/categories/hygiene.png'),
    Category(id: 1, name: 'Beauté', imageUrl: 'assets/categories/beaute.png'),
    Category(id: 1, name: 'Bébé', imageUrl: 'assets/categories/bebe.png'),
    Category(id: 1, name: 'Entretien', imageUrl: 'assets/categories/entretien.png'),
    Category(id: 1, name: 'Maison', imageUrl: 'assets/categories/maison.png'),
  ];
